  ...
  return (
    ...
    <div style={{ minHeight: "100vh", width: "80vh", maxWidth: "100%" }}>
      <Container style={{
        ...
        fontSize: 100 * .021+ 'vw', fontWeight: "1000", color: "#002a4d"
      }}>History</Container>
            ...
            <div style={{ width: "100%" }}>
              {historyData.length === 0 ?
                <div
                  ...
                  style={{ fontWeight: "bold", overflowY: "auto", padding: 100 * 0.03+ 'vh', color: "#002a4d" }}>
                ...
                <div style={{ borderRadius: 100 * .015+ 'vh', height: "69.4vh", width: "100%" }} >
                  ...
                  <div style={{ height: "5vh", fontWeight: 500, color: "#002a4d", fontSize: 100 * 0.01 + 'vw', paddingLeft: 100 * 0.015+ 'vw', paddingTop: 100 * 0.01 + 'vh'}} align="left">
                    Title
                  ...
                  <TableContainer style={{
                    ...
                    backgroundColor: "#c9c9c9", height: "62.5vh", width: "99.5%", overflowY: "auto", overflowX: "hidden" 
                  }}>
