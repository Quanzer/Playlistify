...
style = {{ marginLeft: ".5vw"}}
        ...
        /> 
                        ...
                        <button style={{
                            ...
                            width: isHorizontal?13 * .49 + 'vw': 13 * .73 + 'vh',
                            height: isHorizontal?40 * .06 + 'vh': 13 * .45 + 'vh',
                            fontSize: isHorizontal? 50 * 0.0145 + 'vw':50 * 0.035 + 'vh',
                            borderRadius: '.75vh',
                            marginLeft: ".2vh",
                ...
                marginTop: 100 * .005 + 'vh',
                marginLeft: 100 * .00 + 'vw',
                fontSize: isHorizontal? 100 * 0.0145 + 'vw' : 100 * 0.0245 + 'vh',
                fontWeight: "1000",
                color: theme.palette.text.primary
